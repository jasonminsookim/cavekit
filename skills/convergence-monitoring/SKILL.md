...
**Core insight:** The signal is not zero changes -- it is that remaining changes are trivial.

---

## 1. What Is Convergence?

Convergence is an exponentially decreasing number of changes across iterations:

```
Iteration 1:  ████████████████████████████████████████  200 lines changed
Iteration 2:  ████████████████████                      100 lines changed
Iteration 3:  ██████████                                 50 lines changed
Iteration 4:  ████                                       20 lines changed (minor adjustments)
Iteration 5:  ██                                         10 lines changed (trivial: formatting, comments)
              ^--- Convergence reached
```
...
### Convergence vs ceiling comparison

| Aspect | Convergence | Ceiling |
|--------|-------------|---------|
| **Diff size** | Small and decreasing | Small but flat or oscillating |
| **Change quality** | Trivial (formatting, polish) | Substantive but repetitive |
| **Test pass rate** | Approaching 100% | Stuck at a fixed percentage |
| **Agent behavior** | Confident, checking off exit criteria | Uncertain, retrying same approaches |
| **Impl tracking** | "All tasks DONE" | "BLOCKED" tasks accumulating |
| **Action** | Stop iterating, move on | Investigate the blocker, fix it, resume |
...
Non-convergence:
Iteration 1:  ████████████████████████████████████████  200 lines changed
Iteration 2:  ██████████████████████████████████████    190 lines changed
Iteration 3:  ████████████████████████████████████████  210 lines changed
Iteration 4:  ██████████████████████████████████        170 lines changed
...
| **Fighting sub-agents** | Multiple agents change the same code in conflicting ways | Add file ownership tables; enforce worktree isolation |
...
**Non-convergence is a signal to improve specs, not to run more iterations.**
...
| File conflicts | Add file ownership tables; use worktree isolation |
...
- **Backpropagation:** See `sdd:backpropagation` skill for how tracing bugs to specs improves convergence.
- **Prompt pipeline:** See `sdd:prompt-pipeline` skill for designing prompts with proper exit criteria and completion signals.
- **Validation-first design:** See `sdd:validation-first` skill for building validation gates that provide convergence signals.
- **Impl tracking:** See `sdd:impl-tracking` skill for tracking progress and detecting ceiling conditions.
